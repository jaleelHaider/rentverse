        ...
        <div className="bg-gray-800 rounded-3xl p-8 md:p-12">
          ...
          <div className="mt-12 pt-8 border-t border-gray-700 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-3 bg-gradient-to-r from-primary-600 to-purple-600 text-white rounded-xl font-bold hover:shadow-lg">
                Start Renting
              </button>
              <button className="px-8 py-3 border-2 border-gray-600 text-gray-300 rounded-xl font-bold hover:bg-gray-700">
                Learn More
              </button>
            </div>
          </div>
