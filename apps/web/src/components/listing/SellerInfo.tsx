  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <div className="text-center p-3 bg-gray-50 rounded-lg">
          <div className="text-2xl font-bold text-gray-900">{seller.soldCount ?? 0}</div>
          <div className="text-xs text-gray-500">Items Sold</div>
        </div>
        <div className="text-center p-3 bg-gray-50 rounded-lg">
          <div className="text-2xl font-bold text-gray-900">{seller.rentedCount ?? 0}</div>
      ...
      {seller.profileUrl && (
        <div className="mb-6">
          ...
          >
            View full profile and all reviews
          </Link>
        </div>
      )}
