...
const ProfileDropdown: React.FC<ProfileDropdownProps> = ({
  ...
  const menuItems = {
    main: [
      ...
      { icon: <UserIcon size={18} />, label: 'Profile Settings', path: '/profile-settings', color: 'text-gray-600' },
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-1">
              {isKycVerified ? (
                ...
                <Link
                  to="/profile-settings"
                  className="inline-flex items-center gap-1 text-xs bg-gray-100 text-gray-700 px-2 py-0.5 rounded-full hover:bg-gray-200"
                  onClick={onClose}
                >
                  <AlertCircle size={10} />
                  Unverified
