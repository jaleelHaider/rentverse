    ...
    <div className="container-custom">
      ...
      <div className="grid md:grid-cols-2 gap-8 mt-16">
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          ...
          <button className="w-full mt-8 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700">
            Start Renting
          </button>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          ...
          <button className="w-full mt-8 py-3 bg-green-600 text-white rounded-xl font-bold hover:bg-green-700">
            Start Earning
          </button>
        </div>
      </div>
